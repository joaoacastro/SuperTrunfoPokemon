...
function exibirCartaJogador() {
    ...
    var nome = `<p class="carta-title">${cartaJogador.nome}</p>`
    var tipo = `<p class="carta-tipo">${cartaJogador.tipo}</p>`

    divCartaJogador.innerHTML = moldura + nome + tipo + tagHTML + opcoesTexto + '</div>';
}
...
function exibirCartaMaquina() {
    ...
    var nome = `<p class="carta-titleMaquina">${cartaMaquina.nome}</p>`
    var tipo = `<p class="carta-tipo">${cartaMaquina.tipo}</p>`

    divCartaMaquina.innerHTML = moldura + nome + tipo;
}
...
function exibirInfoCartaMaquina() {
    ...
    divCartaMaquina.innerHTML = moldura + nome + tipo + tagHTML + opcoesTexto + '</div>';
}